                    ...
                    <form id="form__id" class="form__class" method="POST" action="https://getform.io/f/94299acd-9a22-411c-a86f-739c6e149b59">
                        ...
                        <div class="form__group">
                            ...
                            <div class="input__group">
                                <input type="text" id="Name" name="Name" placeholder="Namn" class="form__input" required>
                            </div>
                        </div>
                        ...
                        <div class="form__group">
                            ...
                            <div class="input__group">
                                <input type="email" id="Email" name="Email" placeholder="Epost" class="form__input" required>
                            </div>
                        </div>
