import { language, getformLink } from '../constants';
                ...
                <div class="contact__form__wrapper">
                    <form id="form__id" class="form__class" method="POST" action="${getformLink}">
                        ...
                        <div class="form__group">
                                ...
                                <textarea id="Message" name="Message" class="form__input" placeholder="${
                        ...
                        <div class="form__group">
                            <button type="submit" id="form__button__id" class="form__btn__primary">${
                                inEnglish ? 'Send message' : 'Skicka meddelande'
                            } </button>
                        </div>
                    </form>
                </div>
...
//                         <div class="form__group">
//                             <label for="Name" class="hide__element">${
//                                 inEnglish ? 'Name' : 'Namn'
//                             }</label>
...
//                         <div class="form__group">
//                             <label for="Email" class="hide__element">${
//                                 inEnglish ? 'Email' : 'Epost'
//                             }</label>
//                             <div class="input__group">
//                                 <input type="email" id="Email" name="Email" placeholder="${
...
//                         <div class="form__group">
//                             <label for="Message" class="hide__element">${
//                                 inEnglish ? 'Your message' : 'Ditt meddelande'
//                             } </label>
//                             <div class="input__group">
//                                 <textarea id="Message" name="Message" class="form__input" placeholder="${
//                                     inEnglish ? 'Message' : 'Meddelande'
