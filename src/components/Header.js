        ...
        <div class="container">
          ...
          <div class="social__wrapper">
                <div class="social__links center__margin">
                    ...
                    <a href="https://github.com/jespernyhlen" aria-label="Github" rel="noopener noreferrer" target="_blank" class="social__link">
                        ${icons.github}
                    </a>
                    <a href="https://www.facebook.com/jesper.nyhlen" aria-label="Facebook" rel="noopener noreferrer" target="_blank" class="social__link">
                        ${icons.facebook}
                    </a>
                </div>
            </div>
